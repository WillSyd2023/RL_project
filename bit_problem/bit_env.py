"""RL Bit Environment in Gymnasium"""
...
class BitEnv(gym.Env):
    ...
    - Action from agent is either 'guess 0' or 'guess 1' (string)
    ...
    def __init__(self, p: float | Callable[[int], float]=0.5):
        ...
        self.observation_space = gym.spaces.Text(
            min_length = 1, max_length=1, charset='01')
    ...
    def step(self, action):
        ...
        reward = 1 if int(self._obs) == action else -1
